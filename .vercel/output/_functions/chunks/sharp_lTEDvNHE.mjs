import { a as AstroError, b9 as UnsupportedImageFormat, br as MissingSharp } from './params-and-props_tKlLDTh9.mjs';
import { b as baseService, d as detector, p as parseQuality } from './generic_BlyfiHw2.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_CeTA0sRN.mjs').then(n => n.i)).default;
  } catch {
