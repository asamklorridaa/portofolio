...
const Canva = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g transform="matrix(.26718 0 0 .26718 0 0)">
      ...
      <circle cx="950" cy="950" r="950" fill="url(#canva-a)" />
      <circle cx="950" cy="950" r="950" fill="url(#canva-b)" />
      <circle cx="950" cy="950" r="950" fill="url(#canva-c)" />
      <circle cx="950" cy="950" r="950" fill="url(#canva-d)" />
    </g>
